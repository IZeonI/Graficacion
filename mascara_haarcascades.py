...
mascara = cv2.imread('bat.png', cv2.IMREAD_UNCHANGED)  # Cargar PNG con transparencia
...
while True:
    ...
    for (x, y, w, h) in rostros:
        ...
        mascara_redimensionada = cv2.resize(mascara, (w, int(h/1.8)))
        print(w,h)
        ...
        frame[y:y+int(h/1.8), x:x+w] = resultado
